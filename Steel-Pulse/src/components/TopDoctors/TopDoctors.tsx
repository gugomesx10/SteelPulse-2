...
const TopDoctors: React.FC = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-[#262626] md:mx-10'>
            <h1 className='text-3xl font-medium'>Top Médicos para Agendar</h1>
            <p className='sm:w-1/3 text-center text-sm'>Simplesmente explore nossa lista de médicos confiáveis.</p>
